...
["", "00_hetimafile_cl_test.dart", , R, {
  "^": "",
  main: [function() {
    var file = new N.HetimaFileFS("", null);
    file.fileName = "test.txt";
    P.Future_Future$sync(new R.main_closure(file), null).then$1(new R.main_closure0()).catchError$1(new R.main_closure1());
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "^": "Closure:54;file_0",
    call$0: function() {
      var t1 = this.file_0;
      return t1.write$2(0, "test", 0).then$1(new R.main__closure0(t1));
    },
    $isFunction: true
  },
  main__closure0: {
    ...
    call$1: [function(r) {
      var t1 = this.file_1;
      return t1.getLength$0().then$1(new R.main___closure(t1));
  ...
  main_closure0: {
    ...
    call$1: [function(r) {
      ...
      if (!$._soloTestSeen || $._soloNestingLevel > 0) {
        ...
        t2 = N._fullSpec("filesystem write/read");
        t3 = $.get$_currentContext().get$fullName();
        t4 = $.get$_currentContext();
        t5 = t4._testSetup;
        t4 = t4._testTeardown;
        $.get$_testCases().push(new N.TestCase(t1 + 1, t2, t5, t4, new R.main__closure(r), 0, "", null, null, t3, null, null, true, false, null));
      }
    }, "call$1", null, 2, 0, null, 55, "call"],
    $isFunction: true
  },
  main__closure: {
    "^": "Closure:54;r_3",
    call$0: function() {
      Y.expect("test", C.Utf8Codec_false.decode$1(J.toList$0$ax(J.get$buffer$x(this.r_3))), null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    "^": "Closure:60;",
    call$1: [function(e) {
      Y.expect(true, false, null, null, false);
...
["dart.async", "dart:async", , P, {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:67;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
      var e, s, exception, t1;
      try {
  ...
  _CustomZone_bindUnaryCallback_closure: {
    "^": "Closure:60;this_0,registered_1",
    call$1: [function(arg) {
  ...
  _CustomZone_bindUnaryCallback_closure0: {
    "^": "Closure:60;this_2,registered_3",
    call$1: [function(arg) {
...
["dart.collection", "dart:collection", , P, {
  ...
  _HashMap_addAll_closure: {
    ...
    }, "call$2", null, 4, 0, null, 74, 14, "call"],
    $isFunction: true,
    $signature: function() {
...
["dart.convert", "dart:convert", , P, {
  ...
  Utf8Decoder: {
    ...
    convert$1: function(codeUnits) {
      ...
      if (decoder._expectedUnits > 0) {
        ...
        buffer.write$1(0, H.Primitives_stringFromCharCode(65533));
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:76;this_1,codeUnits_2,startIndex_3,endIndex_4",
    call$2: function(from, to) {
      ...
      t3 = this.codeUnits_2;
      if (t1)
        t2._stringSink.write$1(0, P.String_String$fromCharCodes(t3));
      else
        t2._stringSink.write$1(0, P.String_String$fromCharCodes(J.sublist$2$ax(t3, from, to)));
    },
    $isFunction: true
  }
}],
...
["dart.dom.html", "dart:html", , W, {
  ...
  FileWriter: {
    ...
    get$onWrite: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_write._eventType, false), [null]);
    },
    "%": "FileWriter"
  },
  FormElement: {
...
["hetima_cl", "package:hetima/hetima_cl.dart", , N, {
  "^": "",
  HetimaFileFS: {
    "^": "HetimaFile;fileName,_fileEntry",
    init$0: function() {
      var completer, t1, t2;
      ...
      t1 = window;
      C.Window_methods._requestFileSystem$2(t1, 0, 1024).then$1(new N.HetimaFileFS_init_closure(this, completer));
      return completer.future;
    },
    getLength$0: function() {
      var completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.init$0().then$1(new N.HetimaFileFS_getLength_closure(this, completer));
      return completer.future;
    },
    write$2: function(_, buffer, start) {
      var completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.init$0().then$1(new N.HetimaFileFS_write_closure(this, buffer, start, completer));
      return completer.future;
    },
    read$2: function(start, end) {
      var c_ompleter = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      this.init$0().then$1(new N.HetimaFileFS_read_closure(this, start, end, c_ompleter));
      return c_ompleter.future;
    }
  },
  HetimaFileFS_init_closure: {
    "^": "Closure:85;this_0,completer_1",
    call$1: [function(e) {
      var t1, t2;
      t1 = this.this_0;
      t2 = this.completer_1;
      J.createFile$1$x(J.get$root$x(e), t1.fileName).then$1(new N.HetimaFileFS_init__closure(t1, t2)).catchError$1(new N.HetimaFileFS_init__closure0(t2));
    }, "call$1", null, 2, 0, null, 3, "call"],
    $isFunction: true
  },
  HetimaFileFS_init__closure: {
    "^": "Closure:86;this_2,completer_3",
    call$1: [function(e) {
      var t1;
      H.interceptedTypeCast(e, "$isFileEntry");
      this.this_2._fileEntry = e;
  ...
  HetimaFileFS_init__closure0: {
    "^": "Closure:60;completer_4",
    call$1: [function(es) {
  ...
  HetimaFileFS_getLength_closure: {
    "^": "Closure:60;this_0,completer_1",
    call$1: [function(e) {
      new FileReader();
      J.file$0$x(this.this_0._fileEntry).then$1(new N.HetimaFileFS_getLength__closure(this.completer_1));
    }, "call$1", null, 2, 0, null, 3, "call"],
    $isFunction: true
  },
  HetimaFileFS_getLength__closure: {
    "^": "Closure:88;completer_2",
    call$1: [function(f) {
      var t1, t2;
      t1 = J.get$size$x(f);
  ...
  HetimaFileFS_write_closure: {
    "^": "Closure:60;this_0,buffer_1,start_2,completer_3",
    call$1: [function(e) {
      J.createWriter$0$x(this.this_0._fileEntry).then$1(new N.HetimaFileFS_write__closure(this.buffer_1, this.start_2, this.completer_3));
    }, "call$1", null, 2, 0, null, 3, "call"],
    $isFunction: true
  },
  HetimaFileFS_write__closure: {
    "^": "Closure:90;buffer_4,start_5,completer_6",
    call$1: [function(writer) {
      var t1, t2;
      t1 = J.getInterceptor$x(writer);
      t2 = t1.get$onWrite(writer);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.HetimaFileFS_write___closure(this.completer_6)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = this.start_5;
      if (t2 > 0)
        t1.seek$1(writer, t2);
      t1.write$1(writer, W.Blob_Blob([this.buffer_4], null, null));
    }, "call$1", null, 2, 0, null, 89, "call"],
    $isFunction: true
  },
  HetimaFileFS_write___closure: {
    "^": "Closure:91;completer_7",
    call$1: [function(e) {
      var t1 = this.completer_7.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(new V.WriteResult());
    }, "call$1", null, 2, 0, null, 3, "call"],
    $isFunction: true
  },
  HetimaFileFS_read_closure: {
    "^": "Closure:60;this_0,start_1,end_2,c_ompleter_3",
    call$1: [function(e) {
      var reader = new FileReader();
      J.file$0$x(this.this_0._fileEntry).then$1(new N.HetimaFileFS_read__closure(this.start_1, this.end_2, this.c_ompleter_3, reader));
    }, "call$1", null, 2, 0, null, 3, "call"],
    $isFunction: true
  },
  HetimaFileFS_read__closure: {
    "^": "Closure:88;start_4,end_5,c_ompleter_6,reader_7",
    call$1: [function(f) {
      var t1, t2;
      t1 = this.reader_7;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_load._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.HetimaFileFS_read___closure(this.c_ompleter_6, t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1.readAsArrayBuffer(J.slice$2$x(f, this.start_4, this.end_5));
    }, "call$1", null, 2, 0, null, 24, "call"],
    $isFunction: true
  },
  HetimaFileFS_read___closure: {
    "^": "Closure:91;c_ompleter_8,reader_9",
    call$1: [function(e) {
      var t1, t2;
      t1 = C.FileReader_methods.get$result(this.reader_9);
      t2 = new V.ReadResult(-1, null);
      t2.status = 1;
      t2.buffer = t1;
      t1 = this.c_ompleter_8.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
...
["matcher.core_matchers", "package:matcher/src/core_matchers.dart", , O, {
  ...
  _DeepMatcher: {
    ...
    _recursiveMatch$4: [function(expected, actual, $location, depth) {
      ...
      if (!!J.getInterceptor(expected).$isMatcher) {
        J.matches$2$x(expected, actual, P.LinkedHashMap_LinkedHashMap$_empty(null, null));
      ...
      return ["", $location];
    }, "call$4", "get$_recursiveMatch", 8, 0, 92],
    _match$3: function(expected, actual, matchState) {
      ...
      if (J.$gt$n(J.get$length$asx(t1.$index(rp, 0)), 0))
        reason = J.$gt$n(J.get$length$asx(t1.$index(rp, 1)), 0) ? H.S(t1.$index(rp, 0)) + " at location " + H.S(t1.$index(rp, 1)) : t1.$index(rp, 0);
      else
        reason = "";
    ...
    describeMismatch$4: function(item, mismatchDescription, matchState, verbose) {
      ...
      t1 = J.get$length$asx(reason) === 0 && mismatchDescription._out._contents.length > 0;
  ...
  _DeepMatcher__compareSets_closure: {
    "^": "Closure:60;matcher_0,depth_1,location_2,expectedElement_3",
  ...
  _StringEqualsMatcher: {
    ...
    describeMismatch$4: function(item, mismatchDescription, matchState, verbose) {
      ...
      if (typeof item !== "string") {
        ...
        t1._out.write$1(0, "is not a string");
        return t1;
      } else {
        buff = P.StringBuffer$("");
        buff.write$1(0, "is different.");
        ...
        if (start === minLength1)
          if (minLength0 < minLength) {
            buff.write$1(0, " Both strings start the same, but the given value also has the following trailing characters: ");
            O._StringEqualsMatcher__writeTrailing(buff, escapedItem, minLength0);
          } else {
            buff.write$1(0, " Both strings start the same, but the given value is missing the following trailing characters: ");
    ...
    static: {_StringEqualsMatcher__writeLeading: function(buff, s, start) {
        if (start > 10) {
          buff.write$1(0, "... ");
          buff.write$1(0, C.JSString_methods.substring$2(s, start - 10, start));
        } else
          buff.write$1(0, C.JSString_methods.substring$2(s, 0, start));
      }, _StringEqualsMatcher__writeTrailing: function(buff, s, start) {
        var t1 = start + 10;
        if (t1 > s.length)
          buff.write$1(0, C.JSString_methods.substring$1(s, start));
        else {
          buff.write$1(0, C.JSString_methods.substring$2(s, start, t1));
          buff.write$1(0, " ...");
        }
      }}
  },
  _Predicate: {
    ...
    describe$1: function(description) {
      description._out.write$1(0, this._description);
      return description;
    }
  }
}],
  ...
  StringDescription: {
    ...
    addDescriptionOf$1: function(value) {
      if (!!J.getInterceptor(value).$isMatcher)
        ...
        this._out.write$1(0, S.prettyPrint(value, 25, 80));
      return this;
    }
  }
}],
["matcher.expect", "package:matcher/src/expect.dart", , Y, {
  ...
  _defaultErrorFormatter: [function(actual, matcher, reason, matchState, verbose) {
    ...
    description = new Y.StringDescription(t1);
    t1.write$1(0, "");
    t1.write$1(0, "Expected: ");
    description.addDescriptionOf$1(matcher)._out.write$1(0, "\n");
    t1.write$1(0, "  Actual: ");
    description.addDescriptionOf$1(actual)._out.write$1(0, "\n");
    t2 = P.StringBuffer$("");
    t2.write$1(0, "");
    matcher.describeMismatch$4(actual, new Y.StringDescription(t2), matchState, verbose);
    t2 = t2._contents;
    if (t2.length > 0)
      t1.write$1(0, "   Which: " + t2 + "\n");
    if (reason != null) {
      t1.write$1(0, reason);
      t1.write$1(0, "\n");
    }
...
["matcher.pretty_print", "package:matcher/src/pretty_print.dart", , S, {
  ...
  prettyPrint__prettyPrint: {
    "^": "Closure:94;maxLineLength_1,maxItems_2",
  ...
  prettyPrint__prettyPrint_pp: {
    "^": "Closure:96;box_0,_prettyPrint_3,indent_4",
...
["unittest", "package:unittest/unittest.dart", , N, {
  ...
  SimpleConfiguration: {
    ...
    onTestResult$1: function(testCase) {
      ...
      if (!this.stopTestOnExpectFailure && this._testLogBuffer.length > 0) {
        ...
        reason.write$1(0, lastReasonAndTrace.first);
  ...
  _SpreadArgsHelper: {
    ...
    }, "_max1$0", "call$1", "call$0", "get$_max1", 0, 2, 99, 100, 101],
    ...
    }, "_max2$0", "call$2", "call$1", "call$0", "get$_max2", 0, 4, 102, 100, 100, 101, 103],
    ...
    }, "_max3$2", "call$3", "call$1", "call$0", "call$2", "get$_max3", 0, 6, 104, 100, 100, 100, 101, 103, 105],
    ...
    }, "_max4$3", "call$4", "call$1", "call$0", "call$2", "call$3", "get$_max4", 0, 8, 106, 100, 100, 100, 100, 101, 103, 105, 107],
    ...
    }, "_max5$3", "call$5", "call$1", "call$0", "call$2", "call$4", "call$3", "get$_max5", 0, 10, 108, 100, 100, 100, 100, 100, 101, 103, 105, 107, 109],
    ...
    }, "_max6$5", "call$6", "call$0", "call$1", "call$2", "call$3", "call$4", "call$5", "get$_max6", 0, 12, 110, 100, 100, 100, 100, 100, 100, 101, 103, 105, 107, 109, 111],
  ...
  TestCase__errorHandler_closure: {
    ...
    }, "call$2", null, 4, 0, null, 3, 113, "call"],
    $isFunction: true
  },
...
J.file$0$x = function(receiver) {
  return J.getInterceptor$x(receiver).file$0(receiver);
};
...
C.EventStreamProvider_write = H.setRuntimeTypeInfo(new W.EventStreamProvider("write"), [W.ProgressEvent]);
...
{func: "args0"},
"r",
{func: "dynamic__WriteResult", args: [V.WriteResult]},
"length",
...
"writer",
{func: "dynamic__FileWriter", args: [W.FileWriter]},
...
//# sourceMappingURL=00_hetimafile_cl_test.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function main__closure0(file_1) {
    this.file_1 = file_1;
  }
  ...
  function main___closure(file_2) {
    this.file_2 = file_2;
  }
  ...
  function FileEntry_createWriter_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  ...
  $desc = $collectedClasses.FileEntry_createWriter_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileEntry_createWriter_closure.prototype = $desc;
  function FileEntry_createWriter_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  ...
  $desc = $collectedClasses.FileEntry_createWriter_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileEntry_createWriter_closure0.prototype = $desc;
  function FileEntry_file_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  ...
  $desc = $collectedClasses.FileEntry_file_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileEntry_file_closure.prototype = $desc;
  function FileEntry_file_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  ...
  $desc = $collectedClasses.FileEntry_file_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function Window__requestFileSystem_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  ...
  $desc = $collectedClasses.Window__requestFileSystem_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Window__requestFileSystem_closure.prototype = $desc;
  function Window__requestFileSystem_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  ...
  $desc = $collectedClasses.Window__requestFileSystem_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  WriteResult.builtin$cls = "WriteResult";
  if (!"name" in WriteResult)
    WriteResult.name = "WriteResult";
  $desc = $collectedClasses.WriteResult;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WriteResult.prototype = $desc;
  ...
  function HetimaFileFS(fileName, _fileEntry) {
    this.fileName = fileName;
    this._fileEntry = _fileEntry;
  }
  HetimaFileFS.builtin$cls = "HetimaFileFS";
  if (!"name" in HetimaFileFS)
    HetimaFileFS.name = "HetimaFileFS";
  $desc = $collectedClasses.HetimaFileFS;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS.prototype = $desc;
  function HetimaFileFS_init_closure(this_0, completer_1) {
    this.this_0 = this_0;
    this.completer_1 = completer_1;
  }
  HetimaFileFS_init_closure.builtin$cls = "HetimaFileFS_init_closure";
  if (!"name" in HetimaFileFS_init_closure)
    HetimaFileFS_init_closure.name = "HetimaFileFS_init_closure";
  $desc = $collectedClasses.HetimaFileFS_init_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_init_closure.prototype = $desc;
  function HetimaFileFS_init__closure(this_2, completer_3) {
    this.this_2 = this_2;
    this.completer_3 = completer_3;
  }
  HetimaFileFS_init__closure.builtin$cls = "HetimaFileFS_init__closure";
  if (!"name" in HetimaFileFS_init__closure)
    HetimaFileFS_init__closure.name = "HetimaFileFS_init__closure";
  $desc = $collectedClasses.HetimaFileFS_init__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_init__closure.prototype = $desc;
  function HetimaFileFS_init__closure0(completer_4) {
    this.completer_4 = completer_4;
  }
  HetimaFileFS_init__closure0.builtin$cls = "HetimaFileFS_init__closure0";
  if (!"name" in HetimaFileFS_init__closure0)
    HetimaFileFS_init__closure0.name = "HetimaFileFS_init__closure0";
  $desc = $collectedClasses.HetimaFileFS_init__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_init__closure0.prototype = $desc;
  function HetimaFileFS_getLength_closure(this_0, completer_1) {
    this.this_0 = this_0;
    this.completer_1 = completer_1;
  }
  HetimaFileFS_getLength_closure.builtin$cls = "HetimaFileFS_getLength_closure";
  if (!"name" in HetimaFileFS_getLength_closure)
    HetimaFileFS_getLength_closure.name = "HetimaFileFS_getLength_closure";
  $desc = $collectedClasses.HetimaFileFS_getLength_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_getLength_closure.prototype = $desc;
  function HetimaFileFS_getLength__closure(completer_2) {
    this.completer_2 = completer_2;
  }
  HetimaFileFS_getLength__closure.builtin$cls = "HetimaFileFS_getLength__closure";
  if (!"name" in HetimaFileFS_getLength__closure)
    HetimaFileFS_getLength__closure.name = "HetimaFileFS_getLength__closure";
  $desc = $collectedClasses.HetimaFileFS_getLength__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_getLength__closure.prototype = $desc;
  function HetimaFileFS_write_closure(this_0, buffer_1, start_2, completer_3) {
    this.this_0 = this_0;
    this.buffer_1 = buffer_1;
    this.start_2 = start_2;
    this.completer_3 = completer_3;
  }
  HetimaFileFS_write_closure.builtin$cls = "HetimaFileFS_write_closure";
  if (!"name" in HetimaFileFS_write_closure)
    HetimaFileFS_write_closure.name = "HetimaFileFS_write_closure";
  $desc = $collectedClasses.HetimaFileFS_write_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_write_closure.prototype = $desc;
  function HetimaFileFS_write__closure(buffer_4, start_5, completer_6) {
    this.buffer_4 = buffer_4;
    this.start_5 = start_5;
    this.completer_6 = completer_6;
  }
  HetimaFileFS_write__closure.builtin$cls = "HetimaFileFS_write__closure";
  if (!"name" in HetimaFileFS_write__closure)
    HetimaFileFS_write__closure.name = "HetimaFileFS_write__closure";
  $desc = $collectedClasses.HetimaFileFS_write__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_write__closure.prototype = $desc;
  function HetimaFileFS_write___closure(completer_7) {
    this.completer_7 = completer_7;
  }
  HetimaFileFS_write___closure.builtin$cls = "HetimaFileFS_write___closure";
  if (!"name" in HetimaFileFS_write___closure)
    HetimaFileFS_write___closure.name = "HetimaFileFS_write___closure";
  $desc = $collectedClasses.HetimaFileFS_write___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_write___closure.prototype = $desc;
  function HetimaFileFS_read_closure(this_0, start_1, end_2, c_ompleter_3) {
    this.this_0 = this_0;
    this.start_1 = start_1;
    this.end_2 = end_2;
    this.c_ompleter_3 = c_ompleter_3;
  }
  HetimaFileFS_read_closure.builtin$cls = "HetimaFileFS_read_closure";
  if (!"name" in HetimaFileFS_read_closure)
    HetimaFileFS_read_closure.name = "HetimaFileFS_read_closure";
  $desc = $collectedClasses.HetimaFileFS_read_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_read_closure.prototype = $desc;
  function HetimaFileFS_read__closure(start_4, end_5, c_ompleter_6, reader_7) {
    this.start_4 = start_4;
    this.end_5 = end_5;
    this.c_ompleter_6 = c_ompleter_6;
    this.reader_7 = reader_7;
  }
  HetimaFileFS_read__closure.builtin$cls = "HetimaFileFS_read__closure";
  if (!"name" in HetimaFileFS_read__closure)
    HetimaFileFS_read__closure.name = "HetimaFileFS_read__closure";
  $desc = $collectedClasses.HetimaFileFS_read__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_read__closure.prototype = $desc;
  function HetimaFileFS_read___closure(c_ompleter_8, reader_9) {
    this.c_ompleter_8 = c_ompleter_8;
    this.reader_9 = reader_9;
  }
  HetimaFileFS_read___closure.builtin$cls = "HetimaFileFS_read___closure";
  if (!"name" in HetimaFileFS_read___closure)
    HetimaFileFS_read___closure.name = "HetimaFileFS_read___closure";
  $desc = $collectedClasses.HetimaFileFS_read___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HetimaFileFS_read___closure.prototype = $desc;

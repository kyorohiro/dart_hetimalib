...
["dart.collection", "dart:collection", , P, {
  ...
  _HashMap_addAll_closure: {
    ...
    }, "call$2", null, 4, 0, null, 68, 14, "call"],
    $isFunction: true,
    $signature: function() {
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_scanOneByteCharacters: {
    "^": "Closure:69;endIndex_0",
    call$2: function(units, from) {
      var to, t1, i, unit;
      to = this.endIndex_0;
      for (t1 = J.getInterceptor$as(units), i = from; i < to; ++i) {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:70;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["dart.core", "dart:core", , P, {
  ...
  FormatException: {
    ...
    toString$0: function(_) {
      ...
      if (offset != null) {
        ...
        t1 = t1.$lt(offset, 0) || t1.$gt(offset, J.get$length$as(source));
      } else
        t1 = false;
      if (t1)
        offset = null;
  ...
  Uri: {
    ...
    static: {"^": "Uri__SPACE,Uri__DOUBLE_QUOTE,Uri__NUMBER_SIGN,Uri__PERCENT,Uri__ASTERISK,Uri__PLUS,Uri__SLASH,Uri__ZERO,Uri__NINE,Uri__COLON,Uri__LESS,Uri__GREATER,Uri__QUESTION,Uri__AT_SIGN,Uri__UPPER_CASE_A,Uri__UPPER_CASE_F,Uri__UPPER_CASE_Z,Uri__LEFT_BRACKET,Uri__BACKSLASH,Uri__RIGHT_BRACKET,Uri__LOWER_CASE_A,Uri__LOWER_CASE_F,Uri__LOWER_CASE_Z,Uri__BAR,Uri__unreservedTable,Uri__unreserved2396Table,Uri__encodeFullTable,Uri__schemeTable,Uri__schemeLowerTable,Uri__subDelimitersTable,Uri__genDelimitersTable,Uri__userinfoTable,Uri__regNameTable,Uri__pathCharTable,Uri__pathCharOrSlashTable,Uri__queryCharTable", Uri__defaultPort: function(scheme) {
        ...
        host = P.Uri__makeHost(host, 0, host == null ? 0 : J.get$length$as(host), false);
        ...
        if (!atEnd)
          try {
            J.add$1$a(parts, parseHex.call$2(partStart, end));
          } catch (exception) {
            H.unwrapException(exception);
            try {
        ...
        index = 0;
        while (true) {
          t1 = J.get$length$as(parts);
          if (typeof t1 !== "number")
            return H.iae(t1);
          if (!(i < t1))
            break;
          value = J.$index$as(parts, i);
          t1 = J.getInterceptor(value);
          if (t1.$eq(value, -1)) {
            wildCardLength = 9 - J.get$length$as(parts);
  ...
  HttpUrlDecoder: {
    ...
    innerDecodeUrl$1: function(_url) {
      ...
      try {
        ...
        ret.set$host(this.host$0());
        ret.set$port(this.port$0());
        ret.set$path(this.path$0());
        ret.set$query(this.query$0());
      } catch (exception) {
        H.unwrapException(exception);
        return;
      }
    ...
    host$0: function() {
      try {
        ...
        for (; this.matchChar$1($.get$RfcTable_RFC3986_UNRESERVED());)
          ;
        var t1 = C.Utf8Codec_false.decode$1(this.last$0(0));
        return t1;
      } finally {
        t1 = this.stack;
        if (0 >= t1.length)
    ...
    port$0: function() {
      ...
      try {
        ...
        if (J.get$length$as(portAsList) <= 1)
          return 80;
...
["", "httpurl_test.dart", , Q, {
  "^": "",
  main: [function() {
    N.test("http://127.0.0.1", new Q.main_closure());
    N.test("127.0.0.1", new Q.main_closure0());
    N.test("https://www.google.com:8080", new Q.main_closure1());
    N.test("https://google.com:18080/xxx?sdfsdf=%01%02&aasdf_", new Q.main_closure2());
    N.test("https://google.com:18080/xxx?sdfsdf=%01%02&aasdf_\u3042", new Q.main_closure3());
  }, "call$0", "main$closure", 0, 0, 12],
  main_closure: {
    "^": "Closure:54;",
    call$0: function() {
      var url = new V.HttpUrlDecoder(0, null, []).innerDecodeUrl$1("http://127.0.0.1");
      Y.expect(url.scheme, "http", null, null, false);
      Y.expect(url.host, "127.0.0.1", null, null, false);
      Y.expect(url.port, 80, null, null, false);
      Y.expect(url.path, "", null, null, false);
    },
    $isFunction: true
  },
  main_closure0: {
    "^": "Closure:54;",
    call$0: function() {
      Y.expect(new V.HttpUrlDecoder(0, null, []).innerDecodeUrl$1("127.0.0.1"), null, null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    "^": "Closure:54;",
    call$0: function() {
      var url = new V.HttpUrlDecoder(0, null, []).innerDecodeUrl$1("https://www.google.com:8080");
      Y.expect(url.scheme, "https", null, null, false);
      Y.expect(url.host, "www.google.com", null, null, false);
      Y.expect(url.port, 8080, null, null, false);
      Y.expect(url.path, "", null, null, false);
    },
    $isFunction: true
  },
  main_closure2: {
    "^": "Closure:54;",
    call$0: function() {
      var url = new V.HttpUrlDecoder(0, null, []).innerDecodeUrl$1("https://google.com:18080/xxx?sdfsdf=%01%02&aasdf_");
      Y.expect(url.scheme, "https", null, null, false);
      Y.expect(url.host, "google.com", null, null, false);
      Y.expect(url.port, 18080, null, null, false);
      Y.expect(url.path, "/xxx", null, null, false);
      Y.expect(url.query, "sdfsdf=%01%02&aasdf_", null, null, false);
    },
    $isFunction: true
  },
  main_closure3: {
    "^": "Closure:54;",
    call$0: function() {
      var url = new V.HttpUrlDecoder(0, null, []).innerDecodeUrl$1("https://google.com:18080/xxx?sdfsdf=%01%02&aasdf_\u3042");
      Y.expect(url.scheme, "https", null, null, false);
      Y.expect(url.host, "google.com", null, null, false);
      Y.expect(url.port, 18080, null, null, false);
      Y.expect(url.path, "/xxx", null, null, false);
...
//# sourceMappingURL=httpurl_test.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function HttpUrl(scheme, host, path, query, port) {
    this.scheme = scheme;
    this.host = host;
    this.path = path;
    this.query = query;
  ...
  HttpUrl.builtin$cls = "HttpUrl";
  if (!"name" in HttpUrl)
    HttpUrl.name = "HttpUrl";
  $desc = $collectedClasses.HttpUrl;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HttpUrl.prototype = $desc;
  HttpUrl.prototype.set$scheme = function(v) {
    return this.scheme = v;
  };
  HttpUrl.prototype.set$host = function(v) {
    return this.host = v;
  };
  HttpUrl.prototype.set$path = function(v) {
    return this.path = v;
  };
  HttpUrl.prototype.set$query = function(v) {
    return this.query = v;
  };
  HttpUrl.prototype.set$port = function(v) {
    return this.port = v;
  };
  function HttpUrlDecoder(index, url, stack) {
    this.index = index;
    this.url = url;
    this.stack = stack;
  }
  HttpUrlDecoder.builtin$cls = "HttpUrlDecoder";
  if (!"name" in HttpUrlDecoder)
    HttpUrlDecoder.name = "HttpUrlDecoder";
  $desc = $collectedClasses.HttpUrlDecoder;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HttpUrlDecoder.prototype = $desc;
  function ParseError() {
  }

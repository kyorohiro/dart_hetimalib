...
["", "bencode_test.dart", , N, {
  "^": "",
  main: [function() {
    N.test("bencode: string", new N.main_closure());
    N.test("bencode: number", new N.main_closure0());
    N.test("bencode: list", new N.main_closure1());
    N.test("bencode: join", new N.main_closure2());
    N.test("bencode: dictionary", new N.main_closure3());
  ...
  main_closure: {
    ...
    call$0: function() {
      ...
      t1.encodeObject$1("test");
      out = new Uint8Array(H._ensureNativeList(J.sublist$2$ax(t2._buffer8, 0, t2._hetima$_length)));
      Y.expect("4:test", C.Utf8Codec_false.decode$1(C.NativeUint8List_methods.toList$0(out)), null, null, false);
      t2 = $.get$Bencode__decoder();
      t2.index = 0;
      Y.expect("test", C.Utf8Codec_false.decode$1(J.toList$0$ax(t2.decodeBenObject$1(out))), null, null, false);
    },
    $isFunction: true
  },
  main_closure0: {
    ...
    call$0: function() {
      ...
      t2 = $.get$Bencode__decoder();
      t2.index = 0;
      Y.expect(1024, t2.decodeBenObject$1(out), null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    ...
    call$0: function() {
      ...
      t2 = $.get$Bencode__decoder();
      t2.index = 0;
      list = t2.decodeBenObject$1(out);
      t2 = J.getInterceptor$asx(list);
      Y.expect("test", C.Utf8Codec_false.decode$1(J.toList$0$ax(t2.$index(list, 0))), null, null, false);
      Y.expect(1024, t2.$index(list, 1), null, null, false);
    },
    $isFunction: true
  },
  main_closure2: {
    "^": "Closure:54;",
    call$0: function() {
      var pack, t1, t2, out, m;
      pack = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      pack.$indexSet(0, "action", "join");
      pack.$indexSet(0, "mode", "broadcast");
      pack.$indexSet(0, "id", V.Uuid_s4() + V.Uuid_s4() + "-" + V.Uuid_s4() + "-" + V.Uuid_s4() + "-" + V.Uuid_s4() + "-" + V.Uuid_s4() + V.Uuid_s4() + V.Uuid_s4());
      t1 = $.get$Bencode__encoder();
      t2 = t1.builder;
      t2._hetima$_length = 0;
      t1.encodeObject$1(pack);
      out = new Uint8Array(H._ensureNativeList(J.sublist$2$ax(t2._buffer8, 0, t2._hetima$_length)));
      Y.expect(C.JSString_methods.$add("d6:action4:join4:mode9:broadcast2:id36:", J.toString$0(pack.$index(0, "id"))) + "e", C.Utf8Codec_false.decode$1(C.NativeUint8List_methods.toList$0(out)), null, null, false);
      t2 = $.get$Bencode__decoder();
      t2.index = 0;
      m = t2.decodeBenObject$1(out);
      t2 = J.getInterceptor$asx(m);
      Y.expect(J.toString$0(pack.$index(0, "action")), C.Utf8Codec_false.decode$1(t2.$index(m, "action")), null, null, false);
      Y.expect(J.toString$0(pack.$index(0, "mode")), C.Utf8Codec_false.decode$1(t2.$index(m, "mode")), null, null, false);
      Y.expect(J.toString$0(pack.$index(0, "id")), C.Utf8Codec_false.decode$1(t2.$index(m, "id")), null, null, false);
    },
    $isFunction: true
  },
  main_closure3: {
    ...
    call$0: function() {
      ...
      t2 = $.get$Bencode__decoder();
      t2.index = 0;
      me = t2.decodeBenObject$1(out);
      t2 = J.getInterceptor$asx(me);
      Y.expect("test", C.Utf8Codec_false.decode$1(J.toList$0$ax(t2.$index(me, "test"))), null, null, false);
      Y.expect(1024, t2.$index(me, "value"), null, null, false);
    },
    $isFunction: true
  }
},
...
["dart.async", "dart:async", , P, {
  ...
  _cancelAndErrorClosure_closure: {
    "^": "Closure:67;subscription_0,future_1",
    call$2: function(error, stackTrace) {
...
["dart.collection", "dart:collection", , P, {
  ...
  _HashMap_addAll_closure: {
    ...
    }, "call$2", null, 4, 0, null, 70, 14, "call"],
    $isFunction: true,
    $signature: function() {
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:72;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["hetima", "package:hetima/hetima.dart", , V, {
  "^": "",
  Uuid_s4: function() {
    return C.JSString_methods.substring$2(C.JSInt_methods.toRadixString$1($.get$Uuid__random().nextInt$1(65535) + 65536, 16), 0, 4);
  },
  ArrayBuilder: {
...
["matcher.core_matchers", "package:matcher/src/core_matchers.dart", , O, {
  ...
  _DeepMatcher: {
    ...
    _recursiveMatch$4: [function(expected, actual, $location, depth) {
      ...
      return ["", $location];
    }, "call$4", "get$_recursiveMatch", 8, 0, 81],
...
["matcher.pretty_print", "package:matcher/src/pretty_print.dart", , S, {
  ...
  prettyPrint__prettyPrint: {
    "^": "Closure:83;maxLineLength_1,maxItems_2",
  ...
  prettyPrint__prettyPrint_pp: {
    "^": "Closure:85;box_0,_prettyPrint_3,indent_4",
...
["unittest", "package:unittest/unittest.dart", , N, {
  ...
  _nextTestCase: [function() {
    ...
    N._runTest();
  }, "call$0", "_nextTestCase$closure", 0, 0, 11],
  runTests: [function() {
    if ($._currentTestCaseIndex !== -1)
      H.throwExpression(P.StateError$("Not allowed when tests are running."));
    ...
    $._config.toString;
    N._runTest();
  }, "call$0", "runTests$closure", 0, 0, 11],
  ...
  _SpreadArgsHelper: {
    ...
    }, "_max1$0", "call$1", "call$0", "get$_max1", 0, 2, 88, 89, 90],
    ...
    }, "_max2$1", "call$2", "call$0", "call$1", "get$_max2", 0, 4, 91, 89, 89, 90, 92],
    ...
    }, "_max3$2", "call$3", "call$0", "call$1", "call$2", "get$_max3", 0, 6, 93, 89, 89, 89, 90, 92, 94],
    ...
    }, "_max4$3", "call$4", "call$0", "call$1", "call$2", "call$3", "get$_max4", 0, 8, 95, 89, 89, 89, 89, 90, 92, 94, 96],
    ...
    }, "_max5$3", "call$5", "call$0", "call$1", "call$2", "call$4", "call$3", "get$_max5", 0, 10, 97, 89, 89, 89, 89, 89, 90, 92, 94, 96, 98],
    ...
    }, "_max6$5", "call$6", "call$0", "call$1", "call$2", "call$3", "call$4", "call$5", "get$_max6", 0, 12, 99, 89, 89, 89, 89, 89, 89, 90, 92, 94, 96, 98, 100],
  ...
  TestCase: {
    ...
    }, "call$0", "get$_markCallbackComplete", 0, 0, 11],
    toString$0: function(_) {
      var t1, t2;
      t1 = this._result;
      t2 = this.description;
  ...
  TestCase__errorHandler_closure: {
    ...
    }, "call$2", null, 4, 0, null, 2, 102, "call"],
    $isFunction: true
  },
  ...
  _runTest_closure: {
    ...
    }, "call$2", null, 4, 0, null, 17, 102, "call"],
    $isFunction: true
  },
  _runTest_closure0: {
...
Isolate.$lazy($, "_random", "Uuid__random", "get$Uuid__random", function() {
...
//# sourceMappingURL=bencode_test.dart.js.map
{
  var message =

...
["dart.async", "dart:async", , P, {
  ...
  _cancelAndErrorClosure_closure: {
    "^": "Closure:66;subscription_0,future_1",
    call$2: function(error, stackTrace) {
  ...
  _CustomZone_bindUnaryCallback_closure: {
    "^": "Closure:57;this_0,registered_1",
    call$1: function(arg) {
  ...
  _CustomZone_bindUnaryCallback_closure0: {
    "^": "Closure:57;this_2,registered_3",
    call$1: function(arg) {
...
["dart.collection", "dart:collection", , P, {
  ...
  _HashMap_addAll_closure: {
    ...
    }, "call$2", null, 4, 0, null, 69, 14, "call"],
    $isFunction: true,
    $signature: function() {
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:71;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["hetima", "package:hetima/hetima.dart", , V, {
  ...
  TrackerPeerManager: {
    ...
    update$1: function(request) {
      ...
      t3.PeerAddress$4(C.NativeUint8List_methods.toList$0($.get$PercentEncode__sencoder().decodeWork$1(t2)), request.address, request.ip, H.Primitives_parseInt(request.portAsString, null, null));
      t1.addLast$1(t3);
  ...
  TrackerRequest: {
    ...
    static: {TrackerRequest$fromMap: function(parameter, _address, _ip) {
        var t1 = new V.TrackerRequest("", "", "", "", "", "", "", "", null);
        t1.TrackerRequest$fromMap$3(parameter, _address, _ip);
        return t1;
      }}
  },
  TrackerResponse: {
    ...
    decodeWork$1: function(message) {
      ...
      for (i = 0; i < count; ++i) {
        ...
        if (t3 === "%") {
          ...
          if (i >= t2)
            return H.ioore(message, i);
          t4 = t3.$index(0, message[i]);
          if (typeof t4 !== "number")
            return H.iae(t4);
          ++i;
          if (i >= t2)
            return H.ioore(message, i);
          t3 = t3.$index(0, message[i]);
          if (typeof t3 !== "number")
            return H.iae(t3);
          t1.appendByte$1(((255 & t4) << 4 | 255 & t3) >>> 0);
        } else
          t1.appendString$1(t3);
      }
...
["matcher.core_matchers", "package:matcher/src/core_matchers.dart", , O, {
    ...
    _recursiveMatch$4: [function(expected, actual, $location, depth) {
      ...
      if (depth === 0 || t1 > 1)
        if (!!J.getInterceptor(expected).$isSet)
          ...
          err = J.get$length$asx(expected) === J.get$length$asx(actual) ? "" : "has different length and ";
      ...
      return ["", $location];
    }, "call$4", "get$_recursiveMatch", 8, 0, 80],
  ...
  _DeepMatcher__compareSets_closure: {
    "^": "Closure:57;matcher_0,depth_1,location_2,expectedElement_3",
...
["matcher.pretty_print", "package:matcher/src/pretty_print.dart", , S, {
  ...
  prettyPrint__prettyPrint: {
    "^": "Closure:82;maxLineLength_1,maxItems_2",
  ...
  prettyPrint__prettyPrint_pp: {
    "^": "Closure:84;box_0,_prettyPrint_3,indent_4",
...
["", "trackerpeermanager_test.dart", , Z, {
  "^": "",
  main: [function() {
    P.print("---");
    N.test("compact=0 001", new Z.main_closure());
    N.test("compact=1 001", new Z.main_closure0());
    N.test("compact=0 002", new Z.main_closure1());
  }, "call$0", "main$closure", 0, 0, 12],
  main_closure: {
    "^": "Closure:54;",
    call$0: function() {
      var infoHash, peerId, manager, parameter, responseAsMap, peers, t1;
      infoHash = V.PeerIdCreator_createPeerid("heti");
      peerId = V.PeerIdCreator_createPeerid("heti");
      manager = new V.TrackerPeerManager([], 60, 200, H.setRuntimeTypeInfo(new V.ShuffleLinkedList([], []), [null]));
      manager._managdInfoHash = C.JSArray_methods.toList$0(infoHash);
      parameter = P.LinkedHashMap_LinkedHashMap$_literal(["port", "8080", "event", "", "info_hash", $.get$PercentEncode__sencoder().encodeWork$1(infoHash), "peer_id", $.get$PercentEncode__sencoder().encodeWork$1(peerId), "downloaded", "0", "uploaded", "0", "left", "1024"], null, null);
      responseAsMap = manager.createResponse$0().createResponse$1(false);
      Y.expect(responseAsMap.$index(0, "interval"), 60, null, null, false);
      Y.expect(J.get$length$asx(responseAsMap.$index(0, "peers")), 0, null, null, false);
      manager.update$1(V.TrackerRequest$fromMap(parameter, "1.2.3.4", [1, 2, 3, 4]));
      responseAsMap = manager.createResponse$0().createResponse$1(false);
      Y.expect(responseAsMap.$index(0, "interval"), 60, null, null, false);
      peers = responseAsMap.$index(0, "peers");
      t1 = J.getInterceptor$asx(peers);
      Y.expect(J.$index$asx(t1.$index(peers, 0), "peer_id"), new Uint8Array(H._ensureNativeList(peerId)), null, null, false);
      Y.expect(J.$index$asx(t1.$index(peers, 0), "ip"), "1.2.3.4", null, null, false);
      Y.expect(J.$index$asx(t1.$index(peers, 0), "port"), 8080, null, null, false);
    },
    $isFunction: true
  },
  main_closure0: {
    ...
    call$0: function() {
      ...
      manager = new V.TrackerPeerManager([], 60, 200, H.setRuntimeTypeInfo(new V.ShuffleLinkedList([], []), [null]));
      manager._managdInfoHash = C.JSArray_methods.toList$0(infoHash);
      parameter = P.LinkedHashMap_LinkedHashMap$_literal(["port", "8080", "event", "", "info_hash", $.get$PercentEncode__sencoder().encodeWork$1(infoHash), "peer_id", $.get$PercentEncode__sencoder().encodeWork$1(peerId), "downloaded", "0", "uploaded", "0", "left", "1024", "compact", "1"], null, null);
      responseAsMap = manager.createResponse$0().createResponse$1(false);
      Y.expect(responseAsMap.$index(0, "interval"), 60, null, null, false);
      Y.expect(J.get$length$asx(responseAsMap.$index(0, "peers")), 0, null, null, false);
      manager.update$1(V.TrackerRequest$fromMap(parameter, "1.2.3.4", [1, 2, 3, 4]));
      responseAsMap = manager.createResponse$0().createResponse$1(true);
      Y.expect(responseAsMap.$index(0, "interval"), 60, null, null, false);
      peers = responseAsMap.$index(0, "peers");
      t1 = J.getInterceptor$asx(peers);
      Y.expect(t1.$index(peers, 0), 1, null, null, false);
      Y.expect(t1.$index(peers, 1), 2, null, null, false);
      Y.expect(t1.$index(peers, 2), 3, null, null, false);
      Y.expect(t1.$index(peers, 3), 4, null, null, false);
      Y.expect(t1.$index(peers, 4), 31, null, null, false);
      Y.expect(t1.$index(peers, 5), 144, null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    "^": "Closure:54;",
    call$0: function() {
      var infoHash, peerId01, peerId02, manager, parameter001, parameter002, responseAsMap, peers, t1;
      infoHash = V.PeerIdCreator_createPeerid("heti");
      peerId01 = V.PeerIdCreator_createPeerid("heti");
      peerId02 = V.PeerIdCreator_createPeerid("heti");
      manager = new V.TrackerPeerManager([], 60, 200, H.setRuntimeTypeInfo(new V.ShuffleLinkedList([], []), [null]));
      manager._managdInfoHash = C.JSArray_methods.toList$0(infoHash);
      parameter001 = P.LinkedHashMap_LinkedHashMap$_literal(["port", "8080", "event", "started", "info_hash", $.get$PercentEncode__sencoder().encodeWork$1(infoHash), "peer_id", $.get$PercentEncode__sencoder().encodeWork$1(peerId01), "downloaded", "0", "uploaded", "0", "left", "1024"], null, null);
      parameter002 = P.LinkedHashMap_LinkedHashMap$_literal(["port", "8081", "event", "started", "info_hash", $.get$PercentEncode__sencoder().encodeWork$1(infoHash), "peer_id", $.get$PercentEncode__sencoder().encodeWork$1(peerId02), "downloaded", "0", "uploaded", "0", "left", "1024"], null, null);
      manager.update$1(V.TrackerRequest$fromMap(parameter001, "1.2.3.4", [1, 2, 3, 4]));
      manager.update$1(V.TrackerRequest$fromMap(parameter002, "2.3.4.5", [2, 3, 4, 5]));
      responseAsMap = manager.createResponse$0().createResponse$1(false);
      Y.expect(responseAsMap.$index(0, "interval"), 60, null, null, false);
      peers = responseAsMap.$index(0, "peers");
      t1 = J.getInterceptor$asx(peers);
      if (J.$eq(J.$index$asx(t1.$index(peers, 0), "ip"), "1.2.3.4")) {
        Y.expect(J.$index$asx(t1.$index(peers, 0), "peer_id"), new Uint8Array(H._ensureNativeList(peerId01)), null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 0), "ip"), "1.2.3.4", null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 0), "port"), 8080, null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 1), "peer_id"), new Uint8Array(H._ensureNativeList(peerId02)), null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 1), "ip"), "2.3.4.5", null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 1), "port"), 8081, null, null, false);
      } else {
        Y.expect(J.$index$asx(t1.$index(peers, 1), "peer_id"), new Uint8Array(H._ensureNativeList(peerId01)), null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 1), "ip"), "1.2.3.4", null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 1), "port"), 8080, null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 0), "peer_id"), new Uint8Array(H._ensureNativeList(peerId02)), null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 0), "ip"), "2.3.4.5", null, null, false);
        Y.expect(J.$index$asx(t1.$index(peers, 0), "port"), 8081, null, null, false);
      }
    },
    $isFunction: true
  }
...
["unittest", "package:unittest/unittest.dart", , N, {
  ...
  _SpreadArgsHelper: {
    ...
    }, "_max1$0", "call$1", "call$0", "get$_max1", 0, 2, 87, 88, 89],
    ...
    }, "_max2$1", "call$2", "call$0", "call$1", "get$_max2", 0, 4, 90, 88, 88, 89, 91],
    ...
    }, "_max3$2", "call$3", "call$0", "call$1", "call$2", "get$_max3", 0, 6, 92, 88, 88, 88, 89, 91, 93],
    ...
    }, "_max4$3", "call$4", "call$0", "call$1", "call$2", "call$3", "get$_max4", 0, 8, 94, 88, 88, 88, 88, 89, 91, 93, 95],
    ...
    }, "_max5$3", "call$5", "call$0", "call$1", "call$2", "call$4", "call$3", "get$_max5", 0, 10, 96, 88, 88, 88, 88, 88, 89, 91, 93, 95, 97],
    ...
    }, "_max6$5", "call$6", "call$0", "call$1", "call$2", "call$3", "call$4", "call$5", "get$_max6", 0, 12, 98, 88, 88, 88, 88, 88, 88, 89, 91, 93, 95, 97, 99],
  ...
  TestCase__errorHandler_closure: {
    ...
    }, "call$2", null, 4, 0, null, 2, 101, "call"],
    $isFunction: true
  },
  ...
  _runTest_closure: {
    ...
    }, "call$2", null, 4, 0, null, 17, 101, "call"],
    $isFunction: true
  },
  _runTest_closure0: {
...
//# sourceMappingURL=trackerpeermanager_test.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  _CustomZone.prototype.get$parent = function() {
    return this.parent;
  };
  ...
  function TrackerPeerManager(_managdInfoHash, interval, max, managedPeerAddress) {
    this._managdInfoHash = _managdInfoHash;
    this.interval = interval;
    this.max = max;
    this.managedPeerAddress = managedPeerAddress;
  }
  TrackerPeerManager.builtin$cls = "TrackerPeerManager";
  if (!"name" in TrackerPeerManager)
    TrackerPeerManager.name = "TrackerPeerManager";
  $desc = $collectedClasses.TrackerPeerManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TrackerPeerManager.prototype = $desc;
  function TrackerRequest(portAsString, eventAsString, infoHashAsString, peeridAsString, downloadedAsString, uploadedAsString, leftAsString, address, ip) {
    this.portAsString = portAsString;
    this.eventAsString = eventAsString;
    this.infoHashAsString = infoHashAsString;
    this.peeridAsString = peeridAsString;
    this.downloadedAsString = downloadedAsString;
    this.uploadedAsString = uploadedAsString;
    this.leftAsString = leftAsString;
    this.address = address;
    this.ip = ip;
  }
  TrackerRequest.builtin$cls = "TrackerRequest";
  if (!"name" in TrackerRequest)
    TrackerRequest.name = "TrackerRequest";
  $desc = $collectedClasses.TrackerRequest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TrackerRequest.prototype = $desc;
  TrackerRequest.prototype.get$ip = function() {
    return this.ip;
  };
  function TrackerResponse(interval, peers) {
    this.interval = interval;
    this.peers = peers;
  }
  TrackerResponse.builtin$cls = "TrackerResponse";
  if (!"name" in TrackerResponse)
    TrackerResponse.name = "TrackerResponse";
  $desc = $collectedClasses.TrackerResponse;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TrackerResponse.prototype = $desc;
  function PeerAddress(peerId, address, ip, port) {
    this.peerId = peerId;
    this.address = address;
    this.ip = ip;
    this.port = port;
  }
  PeerAddress.builtin$cls = "PeerAddress";
  if (!"name" in PeerAddress)
    PeerAddress.name = "PeerAddress";
  $desc = $collectedClasses.PeerAddress;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PeerAddress.prototype = $desc;
  PeerAddress.prototype.get$peerId = function() {
    return this.peerId;
  };
  PeerAddress.prototype.get$ip = function() {
    return this.ip;
  };
  PeerAddress.prototype.get$port = function() {
    return this.port;
  };
  function PercentEncode(builder) {
    this.builder = builder;
  }
  PercentEncode.builtin$cls = "PercentEncode";
  if (!"name" in PercentEncode)
    PercentEncode.name = "PercentEncode";
  $desc = $collectedClasses.PercentEncode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PercentEncode.prototype = $desc;
  function ShuffleLinkedList(_sequential, _shuffled) {
    this._sequential = _sequential;
    this._shuffled = _shuffled;
  }
  ShuffleLinkedList.builtin$cls = "ShuffleLinkedList";
  if (!"name" in ShuffleLinkedList)
    ShuffleLinkedList.name = "ShuffleLinkedList";
  $desc = $collectedClasses.ShuffleLinkedList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ShuffleLinkedList.prototype = $desc;

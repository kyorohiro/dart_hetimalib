...
["hetima", "package:hetima/hetima.dart", , V, {
  ...
  HttpUrlDecoder_queryMap: function(query) {
    var ret, t1, pats, pat, pa, key, t2;
    ret = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
    t1 = query.length;
    if (t1 !== 0)
      t1 = !H.stringContainsUnchecked(query, "=", 0);
    else
      t1 = true;
    if (t1)
      return P.LinkedHashMap_LinkedHashMap$_empty(null, null);
    pats = query.split("&");
    for (t1 = new H.ListIterator(pats, pats.length, 0, null); t1.moveNext$0();) {
      pat = t1._current;
      pa = J.getInterceptor$s(pat).split$1(pat, "=");
      if (0 >= pa.length)
        return H.ioore(pa, 0);
      key = pa[0];
      t2 = J.get$length$as(key);
      if (typeof t2 !== "number")
        return t2.$add();
      ret.$indexSet(0, key, C.JSString_methods.substring$1(pat, t2 + 1));
    }
    return ret;
  },
  HetiTest: {
...
["", "httpurldecoder_test.dart", , V, {
  "^": "",
  main: [function() {
    var test, ticket, map;
    test = new V.HetiTest(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), 0, "");
    test._id = "t";
    ticket = test.test$2("a", 3000);
    map = V.HttpUrlDecoder_queryMap("");
    ticket.assertTrue$2("", 0 === map.get$length(map));
    ticket.fin$0();
    ticket = test.test$2("aa", 3000);
    map = V.HttpUrlDecoder_queryMap("=");
    ticket.assertTrue$2("", 1 === map.get$length(map));
    ticket.assertTrue$2("", "" === map.$index(0, ""));
    ticket.fin$0();
    ticket = test.test$2("b", 3000);
    map = V.HttpUrlDecoder_queryMap("xxx=ccc");
    ticket.assertTrue$2("1:" + C.JSInt_methods.toString$0(map.get$length(map)), 1 === map.get$length(map));
    ticket.assertTrue$2("2:", "ccc" === map.$index(0, "xxx"));
    ticket.fin$0();
    ticket = test.test$2("c", 3000);
    map = V.HttpUrlDecoder_queryMap("xxx=ccc&ddd=xxx");
    ticket.assertTrue$2("1:" + C.JSInt_methods.toString$0(map.get$length(map)), 2 === map.get$length(map));
    ticket.assertTrue$2("2:", "ccc" === map.$index(0, "xxx"));
    ticket.assertTrue$2("3:", "xxx" === map.$index(0, "ddd"));
    ticket.fin$0();
    ticket = test.test$2("d", 3000);
    map = V.HttpUrlDecoder_queryMap("xxx=ccc&ddd=x?x");
    ticket.assertTrue$2("1:" + C.JSInt_methods.toString$0(map.get$length(map)), 2 === map.get$length(map));
    ticket.assertTrue$2("2:", "ccc" === map.$index(0, "xxx"));
    ticket.assertTrue$2("3:", "x?x" === map.$index(0, "ddd"));
    ticket.fin$0();
    ticket = test.test$2("e", 3000);
    ticket.assertTrue$2("2:", "%5F%C6%B8%A2%64%63%33%F5%63%9D%4E%95%2B%9B%B8%AD%EE%12%1A%BD" === V.HttpUrlDecoder_queryMap("info_hash=%5F%C6%B8%A2%64%63%33%F5%63%9D%4E%95%2B%9B%B8%AD%EE%12%1A%BD&port=6969&peer_id=%2D%2D%74%65%73%74%87%E4%36%2A%55%AB%0C%E2%B5%33%C2%4B%79%84&event=started&uploaded=0&downloaded=0&left=0").$index(0, "info_hash"));
    ticket.fin$0();
    ticket = test.test$2("f", 3000);
    ticket.assertTrue$2("2:", "%5F%C6%B8%A2%64%63%33%F5%63%9D%4E%95%2B%9B%B8%AD%EE%12%1A%BD" === V.HttpUrlDecoder_queryMap("info_hash=%5F%C6%B8%A2%64%63%33%F5%63%9D%4E%95%2B%9B%B8%AD%EE%12%1A%BD&port=6969&peer_id=%2D%2D%74%65%73%74%87%E4%36%2A%55%AB%0C%E2%B5%33%C2%4B%79%84&event=started&uploaded=0&downloaded=0&left=0").$index(0, "info_hash"));
    ticket.fin$0();
    ticket = test.test$2("g", 3000);
    ticket.assertTrue$2("2:", "_%C6%B8%A2dc3%F5c%9DN%95%2B%9B%B8%AD%EE%12%1A%BD" === V.HttpUrlDecoder_queryMap("info_hash=_%C6%B8%A2dc3%F5c%9DN%95%2B%9B%B8%AD%EE%12%1A%BD&port=6969&peer_id=--test%87%E46%2AU%AB%0C%E2%B53%C2Ky%84&event=started&uploaded=0&downloaded=0&left=0").$index(0, "info_hash"));
    ticket.fin$0();
    ticket = test.test$2("h", 3000);
    ticket.assertTrue$2("2:", "_%C6%B8%A2dc3%F5c%9DN%95%2B%9B%B8%AD%EE%12%1A%BD" === V.HttpUrlDecoder_queryMap("info_hash=_%C6%B8%A2dc3%F5c%9DN%95%2B%9B%B8%AD%EE%12%1A%BD&port=6969&peer_id=--test%87%E46%2AU%AB%0C%E2%B53%C2Ky%84&event=started&uploaded=0&downloaded=0&left=0").$index(0, "info_hash"));
    ticket.fin$0();
...
//# sourceMappingURL=httpurldecoder_test.dart.js.map
{
  var message =

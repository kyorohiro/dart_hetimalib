...
["", "arraybuilder_test.dart", , L, {
  "^": "",
  main: [function() {
    new V.HetiTest(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), 0, "")._id = "tt";
    N.test("arraybuilder: init", new L.main_closure());
    N.test("arraybuilder: senario", new L.main_closure0());
    N.test("arraybuilder: big/little", new L.main_closure1());
  ...
  main_closure: {
    ...
    call$0: function() {
      ...
      t3 = new Uint8Array(1024);
      new V.ArrayBuilder(1024, null, 0, t1, [], t2, false)._buffer8 = t3;
      Y.expect(0, 0, null, null, false);
      Y.expect(0, C.NativeUint8List_methods.sublist$2(t3, 0, 0).length, null, null, false);
      Y.expect("", C.Utf8Codec_false.decode$1(C.NativeUint8List_methods.sublist$2(t3, 0, 0)), null, null, false);
    },
    $isFunction: true
  },
  main_closure0: {
    "^": "Closure:54;",
    call$0: function() {
      var builder = new V.ArrayBuilder(1024, null, 0, H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), [], H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), false);
      builder._buffer8 = new Uint8Array(1024);
      builder.appendString$1("abc");
      Y.expect("abc", C.Utf8Codec_false.decode$1(J.sublist$2$ax(builder._buffer8, 0, builder._hetima$_length)), null, null, false);
      Y.expect(3, J.sublist$2$ax(builder._buffer8, 0, builder._hetima$_length).length, null, null, false);
      builder.appendString$1("abc");
      Y.expect("abcabc", C.Utf8Codec_false.decode$1(J.sublist$2$ax(builder._buffer8, 0, builder._hetima$_length)), null, null, false);
      Y.expect(6, J.sublist$2$ax(builder._buffer8, 0, builder._hetima$_length).length, null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    ...
    call$0: function() {
      ...
      ret[6] = 0;
      ret[7] = 255;
      Y.expect(ret[0], 0, null, null, false);
      Y.expect(ret[1], 0, null, null, false);
      Y.expect(ret[2], 0, null, null, false);
      Y.expect(ret[3], 0, null, null, false);
      Y.expect(ret[4], 0, null, null, false);
      Y.expect(ret[5], 0, null, null, false);
      Y.expect(ret[6], 0, null, null, false);
      Y.expect(ret[7], 255, null, null, false);
      Y.expect((0 | C.JSInt_methods._shlPositive$1(J.$and$n(ret[0], 255), 56) | C.JSInt_methods._shlPositive$1(J.$and$n(ret[1], 255), 48) | C.JSInt_methods._shlPositive$1(J.$and$n(ret[2], 255), 40) | C.JSInt_methods._shlPositive$1(J.$and$n(ret[3], 255), 32) | J.$and$n(ret[4], 255) << 24 | J.$and$n(ret[5], 255) << 16 | J.$and$n(ret[6], 255) << 8 | J.$and$n(ret[7], 255) << 0) >>> 0, 255, null, null, false);
      ret = Array(4);
      ret[0] = 0;
      ret[1] = 0;
      ret[2] = 0;
      ...
      Y.expect(ret[1], 0, null, null, false);
      Y.expect(ret[2], 0, null, null, false);
      Y.expect(ret[3], 255, null, null, false);
      t1 = ret[0];
      if (typeof t1 !== "number")
        return t1.$and();
      t2 = ret[1];
      ...
      if (typeof t4 !== "number")
        return t4.$and();
      ret = (0 | (t1 & 255) << 24 | (t2 & 255) << 16 | (t3 & 255) << 8 | (t4 & 255) << 0) >>> 0;
      Y.expect(ret, 255, null, null, false);
      ret = Array(4);
      ret[0] = 0;
      ret[1] = 255;
      Y.expect(ret[0], 0, null, null, false);
      Y.expect(ret[1], 255, null, null, false);
      t1 = ret[0];
      if (typeof t1 !== "number")
        return t1.$and();
      t2 = ret[1];
...
//# sourceMappingURL=arraybuilder_test.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function _Utf8Decoder(_allowMalformed, _stringSink, _isFirstCharacter, _value, _expectedUnits, _extraUnits) {
    this._allowMalformed = _allowMalformed;
